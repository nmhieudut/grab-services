            ...
            <TouchableOpacity activeOpacity={0.9} style={{ flex: 1 }}>
                ...
                <View style={styles.welcome}>
                    ...
                    <View style={{ marginVertical: 12 }}>
                        <Text style={{ fontSize: 30, color: 'white', fontWeight: '700' }}>GRAB SERVICES</Text>
                    </View>
                    <View>
                                ...
                                <View style={styles.textInput} >
                                    <View style={styles.inputTextContainer}>
                                        <Input
                                            ...
                                            leftIcon={<LIcon name='user' size={24} style={{ color: `${color.PRIMARY}` }} />}
                                ...
                                <View style={styles.textInput}>
                                    <View style={styles.inputTextContainer}>
                                        <Input
                                            ...
                                            placeholder='abc123'
                                            inputContainerStyle={{ color: 'black', fontSize: 18 }}
                                            leftIcon={<MCIcon name='lock' size={24} color='black' style={{ color: `${color.PRIMARY}` }} />}
                                            errorStyle={{ color: 'red', fontSize: 16 }}
                ...
                <View style={styles.registerButtonContainer}>
                    <Text style={{ flex: 1.5, textAlign: 'right' }}>Not have account yet ? </Text>
                    <TouchableOpacity
