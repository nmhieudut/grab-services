            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={styles.picAndName}>
                    ...
                    <View style={styles.name}>
                        <Text style={{ fontSize: 26, color: 'white' }}>{userProps.displayName}</Text>
                    </View>
                </View>
                {/* Body */}
                <View style={styles.info}>
                    <View style={styles.detailInfo}>
                        ...
                        <TouchableOpacity style={{ flexDirection: 'row' }}>
                            ...
                            <Icon name="right" size={16} color='grey' style={{ marginTop: 5, marginLeft: 5 }} />
                        </TouchableOpacity>
                    </View>
                    <View style={styles.detailInfo}>
                    ...
                    <View style={styles.detailInfo}>
                        ...
                        <TouchableOpacity style={{ flexDirection: 'row' }}>
                            <Text style={styles.infoView}></Text>
                            <Icon name="right" size={16} color='grey' style={{ marginTop: 5, marginLeft: 5 }} />
                        </TouchableOpacity>
                    </View>
                    <View style={styles.detailInfo}>
