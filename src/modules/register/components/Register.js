...
import { RadioButton, FAB, Provider } from 'react-native-paper';
                    ...
                    {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                        <View>
                            ...
                            <View style={styles.checkGender}>
                                <View>
                                    <Text style={{ color: color.PRIMARY, fontSize: 18, fontWeight: '700' }}>Gender: </Text>
                                </View>
                            ...
                            <View style={styles.checkGender}>
                                <View>
                                    <Text style={{ color: color.PRIMARY, fontSize: 18, fontWeight: '700' }}>Date of birth: </Text>
                                </View>
                                <DatePicker
                                    style={{ width: 200 }}
                                    date={date}
                            ...
                            <View style={styles.checkUser}>
                                <View>
                                    <Text style={{ color: color.PRIMARY, fontSize: 18, fontWeight: '700' }}>You are: </Text>
                                </View>
                                <RadioButton.Group onValueChange={handleChange('roles')} value={values.roles}>
